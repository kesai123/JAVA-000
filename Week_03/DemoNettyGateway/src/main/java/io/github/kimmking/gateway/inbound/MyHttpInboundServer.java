...
public class MyHttpInboundServer {
    ...
    public MyHttpInboundServer(int port, String proxyServer) {
        this.port=port;
    ...
    public void run() throws Exception {
        ...
        //为当前channel注入filter
        MyHttpRequestFilter filter = new MyHttpRequestFilter();
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    ...
                    .childHandler(new MyHttpInboundInitializer(this.proxyServer, filter));
